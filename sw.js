const SHELL = 'arcane-shell-v0.7.0';
const IMAGES = 'arcane-card-images-v0.2.0';
const ASSETS = ['./','./index.html','./styles.css','./v03.css','./v04.css','./v05.css','./v06.css','./v062.css','./v07.css','./app.js','./v062-pre.js','./v03.js','./v04.js','./v05.js','./v06.js','./v062.js','./v07.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
